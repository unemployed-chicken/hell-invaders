...
constexpr int demon_attack_rate_in_milliseconds{ 3000 }; // How long a demon will pause after an attack before looking to attack again //TODO: Convert to Milliseconds
