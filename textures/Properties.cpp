...
void Properties::generateHighScores() {
    FILE* fp;
    is_windows_os ? fopen_s(&fp, "props/high_scores.json", "rb") : fopen_s(&fp, "props/high_scores.json", "r"); // non-Windows use "r" 
...
Properties::Properties() {
	...
	FILE* fp;
    is_windows_os ? fopen_s(&fp, "props/user_defined_properties.json", "rb") : fopen_s(&fp, "props/user_defined_properties.json", "r"); // non-Windows use "r" 
...
void Properties::saveScores() {
    FILE* fp;
    is_windows_os ? fopen_s(&fp, "props/high_scores.json", "wb") : fopen_s(&fp, "props/high_scores.json", "w"); // non-Windows use "w" 
...
void Properties::saveProperties() {
    FILE* fp;
    is_windows_os ? fopen_s(&fp, "props/user_defined_properties.json", "wb") : fopen_s(&fp, "props/user_defined_properties.json", "w"); // non-Windows use "w" 
...
rapidjson::Document Properties::generatePropertyDescriptions() {
    ...
    FILE* fp;
    is_windows_os ? fopen_s(&fp, "props/properties_details.json", "rb") : fopen_s(&fp, "props/properties_details.json", "r"); // non-Windows use "r" 
